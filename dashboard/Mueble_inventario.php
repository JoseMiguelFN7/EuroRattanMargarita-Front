    ...
    <body class="m-0 font-sans text-base antialiased font-normal leading-default bg-gray-50 text-slate-500 max-w-screen">
        ...
        <section class="">
          <div class="md:mb-0 pt-6"> 
            <h1 class=" text-xxl font-medium text-center text-gray-600 md:text-stroke-brown cursor-pointer" onclick="window.location.href='./'">Muebles</h1>
          </div>
        </section>
                        ...
                        <div class="max-h-96 overflow-y-auto border border-gray-300 rounded-lg p-4">
                            ...
                            <thead class="bg-gray-100 sticky top-0 z-10 border-collapse ">
                                <tr class="w-full border-b border-gray-300">
                                    <th class="px-4 py-2 font-bold text-left text-sm text-gray-700 border-b ">img.</th>
                                    ...
                                    <th class="px-4 py-2 font-bold text-left text-sm text-gray-700 border-b">Editar</th>
                                </tr>
                            </thead>
                            <tbody>
                                <!-- Ejemplo de filas -->
                                <tr class="w-full">
                                <td class="px-4 py-2 font-bold text-left text-sm text-gray-700 border-b border-gray-300">
                                    <div class="flex flex-col justify-center items-center">
                                        <img id="previewImage" for="fileInput" src="../assets/img/no-image.png" alt="" class="customFileButton w-9 h-9 object-cover rounded-full mb-2 cursor-pointer" />
                                    </div>
                                </td>
