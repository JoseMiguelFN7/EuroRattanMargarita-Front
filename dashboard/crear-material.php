    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $('#materialtypes').select2({
                placeholder: "Tipo de material", // Placeholder para el select
                ...
                ajax: {
                    ...
                    processResults: function (data) {
                        // Mapea los resultados del servidor al formato esperado por Select2
                        return {
                            results: data.map(item => ({
                                id: item.id, // ID único de la opción
                                text: item.name // Texto que se mostrará al usuario
                            }))
                        };
                    },
                }
