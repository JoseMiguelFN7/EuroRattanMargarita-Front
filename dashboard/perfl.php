...
<body class="m-0 font-sans text-base antialiased font-normal leading-default bg-gray-50 text-slate-500 max-w-screen">
    ...
    <aside style="background-color: #CCD5AE;" class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0  block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto  border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:bg-transparent">
        <div class="h-19.5">
        ...
        <div class="flex flex-col bg-white rounded-lg shadow-lg max-w-sm lg:w-2/3 lg:flex-row ">
          ...
          <div class="w-full p-6 lg:w-1/2">
            ...
            <div class="mb-8 flex flex-col md:flex-row">
                <input placeholder="Please enter your full name" class="mb-2 mr-4 flex h-full w-full items-center justify-center rounded-lg border border-zinc-200 bg-white/0 px-4 py-4 text-zinc-950 outline-none dark:!border-white/10 dark:text-white md:mb-0" type="text" value="VBZ" name="fullName">
            </div>

            <h1 class="text-2xl font-semibold text-gray-700 text-lg">Correo electronico</h1>
            <div class="mb-8 flex flex-col md:flex-row">
                <input placeholder="Please enter your full name" class="mb-2 mr-4 flex h-full w-full items-center justify-center rounded-lg border border-zinc-200 bg-white/0 px-4 py-4 text-zinc-950 outline-none dark:!border-white/10 dark:text-white md:mb-0" type="text" value="VBZ" name="fullName">
            </div>

            <h1 class="text-2xl font-semibold text-gray-700 text-lg">Telefono</h1>
            <div class="mb-8 flex flex-col md:flex-row">
                <input placeholder="Please enter your full name" class="mb-2 mr-4 flex h-full w-full items-center justify-center rounded-lg border border-zinc-200 bg-white/0 px-4 py-4 text-zinc-950 outline-none dark:!border-white/10 dark:text-white md:mb-0" type="text" value="VBZ" name="fullName">
            </div>

            <h1 class="text-2xl font-semibold text-gray-700 text-lg">Ubicacion</h1>
            <div class="mb-8 flex flex-col md:flex-row">
                <input placeholder="Please enter your full name" class="mb-2 mr-4 flex h-full w-full items-center justify-center rounded-lg border border-zinc-200 bg-white/0 px-4 py-4 text-zinc-950 outline-none dark:!border-white/10 dark:text-white md:mb-0" type="text" value="VBZ" name="fullName">
            </div>
            <!-- Más contenido -->
