      ...
      <div class="w-1 justify-center flex p-2 pt-4">
        ...
        <form id="formUpdate" enctype="multipart/form-data" class="flex flex-col bg-white rounded-lg shadow-lg max-w-sm lg:w-2/3 lg:flex-row ">
          ...
          <div class="w-full p-6 md:w-1/2">
            ...
            <!--<label class="text-2xl font-semibold text-gray-700 text-lg">Teléfono</label>
            <div class="mb-8 flex flex-col md:flex-row">
                <input type="text" name="fullName" placeholder="Ingresa tu número de teléfono" class="mb-2 mr-4 flex h-full w-full items-center justify-center rounded-lg border border-zinc-200 bg-white/0 px-4 py-4 text-zinc-950 outline-none dark:!border-white/10 dark:text-white md:mb-0">
            </div>-->
