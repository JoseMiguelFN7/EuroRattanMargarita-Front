<footer class="bg-gray-800 text-white"> 
    <div class="w-full mx-auto px-6 py-8"> 
        <div class="flex flex-col md:flex-row md:flex-wrap justify-between"> 
            ...
            <div class="w-full text-center md:text-left md:w-1/3 mb-6 md:mb-0"> 
                <div class="flex flex-row items-center justify-center md:justify-start mb-4">
                    <img src="./assets/img/icons8-ubicación-50.png" alt="ubication Icon" width="24" height="24" class="mr-2">
                    <h5 class="font-semibold text-white m-0">Ubicación</h5>
                </div>
            ...
            <div class="w-full text-center md:text-right md:w-1/3 mb-6 md:mb-0 flex flex-col"> 
                ...
                <div class="flex flex-row items-center md:justify-end justify-center"> 
                    <a href="https://www.instagram.com/eurorattanmargarita/" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-gray-200 mr-2"> 
                        <img src="./assets/img/icons8-instagram.svg" alt="Instagram Icon" width="24" height="24">
                    </a>
                    <a href="https://wa.me/+584147894819" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-gray-200 mx-2"> 
                        <img src="./assets/img/whatsapp-svgrepo-com.svg" alt="WhatsApp Icon" width="24" height="24">
                    </a>
                    <a href="https://www.facebook.com/profile.php?id=100081308348549&mibextid=ZbWKwL" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-gray-200 ml-2">
                        <img src="./assets/img/icons8-facebook.svg" alt="facebook Icon" width="24" height="24">
                    </a>
                </div>
                ...
                <div class="flex md:flex-row flex-row-reverse items-center md:justify-end justify-center mt-4">
                    ...
                    <img src="./assets/img/icons8-correo-24.png" alt="cellphone Icon" width="24" height="24" class="mr-2 md:ml-2 md:mr-0">
                </div>
            </div>
        </div>
        <p class="m-0 text-center text-gray-500 pt-4">
            &copy; 2024 Euro Rattan Margarita. Todos los derechos reservados.
        </p>
    </div>
</footer>