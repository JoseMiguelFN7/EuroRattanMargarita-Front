<footer class="bg-gray-800 text-white py-8"> 
    <div class="w-full mx-auto px-4 py-4"> 
        <div class="flex flex-nowrap md:flex-wrap justify-between items-center"> 
            ...
            <div class="w-full md:w-1/3 mb-6 md:mb-0 text-center"> 
                <h1 class="text-3xl font-bamboo text-stroke-brown">Euro Rattan Margarita</h1> 
            </div> 
            <!-- Sección de Redes Sociales --> 
            <div class="w-full md:w-1/3 mb-6 md:mb-0 flex flex-col items-end"> 
                <h5 class="text-lg font-semibold mb-4 text-white">Contáctanos</h5> 
                <div class="flex space-x-4"> 
                    <a href="https://www.instagram.com/eurorattanmargarita/" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-gray-200 px-2"> 
                    ...
                    <a href="https://wa.me/+584147894819" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-gray-200 px-2"> 
                    ...
                    <a href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-gray-200 px-2">
                ...
                <p class="text-gray-400 mt-4">+58 414 7894819</p>
                <p class="text-gray-400">eurorattan62@gmail.com</p>
            </div>
        </div>
        <p class="mt-8 text-center text-gray-500 p-2">
